    ...
    <div class="row mb-5 mt-5">
      <div class="col-md-12">
        <div class="description text-white mb-5">
          <p>"Мне в Электростали живется нормально": Как писать треки в духе WARP и вдохновляться самой большой в Европе свалкой.</p>
          <p>
          ...
          <p>
            В интервью Денис рассказал, почему в Электростали все любят металл, в чем прелесть работы часовщиком, как быть андердогом, не напрягаясь, и отделять музыку от политики.
          </p>
        </div>
    ...
    <div class="row mb-5">
      <div class="col-md-6 offset-md-2">
        <iframe
          ...
          seamless
        >
          <a href="https://mestnost.bandcamp.com/album/sleep-paralysis">Sleep Paralysis by Anderdog</a>
        </iframe>
      </div>
    </div>
    <div class="row mb-5">
