    ...
    <div class="row mb-5 mt-5">
      <div class="col-md-12">
        ...
        <div class="col-md-6 offset-md-2">
          <iframe style="border: 0; width: 100%; height: 120px;" src="https://bandcamp.com/EmbeddedPlayer/album=144619080/size=large/bgcol=333333/linkcol=0f91ff/tracklist=false/artwork=small/transparent=true/" seamless>
            <a href="https://mestnost.bandcamp.com/album/limes">Limes by Morakh</a>
          </iframe>
        </div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      links: [
        { name: 'Bandcamp', icon: 'bandcamp', link: 'https://mestnost.bandcamp.com/album/limes' },
        { name: 'Apple Music', icon: 'apple', link: 'https://music.apple.com/ru/album/limes/1629759488' },
        { name: 'Spotify', icon: 'spotify', link: 'https://open.spotify.com/album/36xRrbdkALsaul9ELsjreQ' },
        { name: 'Yandex', icon: 'yandex', link: 'https://music.yandex.ru/album/22917650' }
      ]
    }
  },
}
